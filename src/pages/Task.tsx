...
export default function Task() {
  ...
  const handleSubmit = async () => {
    ...
    setIsLoading(true); // Aktifkan loading sebelum request dimulai
    ...
    try {
      ...
      alert("Kesalahan saat mengunggah.");
    } finally {
            ...
            {taskData ? (
              <>
                ...
                <div className="">
                  ...
                  {taskData.fileUrl &&
                    (() => {
                      ...
                      }${taskData.fileUrl.replace(/\\/g, "/")}`;
                      const fileExtension = taskData.fileUrl
                        .split(".")
                        .pop()
                        ?.toLowerCase();
                      const isImage = [
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl">
                  ...
                  <input
                    type="text"
                    placeholder="Masukkan Keterangan (Tidak Wajib)"
                    value={note}
                  ...
                  >
                    {isLoading ? "Mengunggah..." : "Unggah Tugas"}
                  </button>
                </div>
              </>
            ) : (
